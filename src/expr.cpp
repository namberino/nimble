...
SubscriptExpr::SubscriptExpr(std::shared_ptr<Expr> name, Token paren, std::shared_ptr<Expr> index, std::shared_ptr<Expr> value)
    : name(std::move(name)), paren(std::move(paren)), index(std::move(index)), value(std::move(value)) {}
